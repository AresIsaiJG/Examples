...
### Advertencias
* ***ADVERTENCIA 1:*** El acceso por *bit-field* puede ser más lento y generar más instrucciones de las necesarias, a diferencia de hacer la escritura por *bitwise*.
